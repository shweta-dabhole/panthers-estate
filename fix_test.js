...
const endIdx = code.indexOf('export default function Home() {');

code = code.substring(0, startIdx) + interactiveTestimonials + '\n\n' + code.substring(endIdx);

fs.writeFileSync('app/page.js', code, 'utf8');
console.log("Fixed Testimonials syntax error.");
