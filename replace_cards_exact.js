...
const newSection = `{/* 4. About Us Section (Who Are We) */}
        ...
        >
          ...
          <div className="w-full max-w-[1200px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" ref={cardsSectionRef}>
            {/* Card 1 */}
            <div className="stat-card bg-[#f9f9f9] rounded-[15px] p-8 border-[1.3px] border-[#e6e6e6] flex flex-col justify-start">
              <div className="text-[#666666] mb-12">
              ...
              <div>
                <h4 className="text-[40px] font-[600] text-[#191919] tracking-[-0.04em] leading-[1em] mb-3">5000+</h4>
                <p className="text-[#191919] text-[15px] font-normal leading-[1.2]">Property deliverd</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#f9f9f9] rounded-[15px] p-8 border-[1.3px] border-[#e6e6e6] flex flex-col justify-start">
              ...
              <div>
                <h4 className="text-[40px] font-[600] text-[#191919] tracking-[-0.04em] leading-[1em] mb-3">2000+</h4>
                <p className="text-[#191919] text-[15px] font-normal leading-[1.2]">Client served worldwide</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#f9f9f9] rounded-[15px] p-8 border-[1.3px] border-[#e6e6e6] flex flex-col justify-start">
              ...
              <div>
                <h4 className="text-[40px] font-[600] text-[#191919] tracking-[-0.04em] leading-[1em] mb-3">100+</h4>
                <p className="text-[#191919] text-[15px] font-normal leading-[1.2]">Awards</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#f9f9f9] rounded-[15px] p-8 border-[1.3px] border-[#e6e6e6] flex flex-col justify-start">
              ...
              <div>
                <h4 className="text-[40px] font-[600] text-[#191919] tracking-[-0.04em] leading-[1em] mb-3">12+</h4>
                <p className="text-[#191919] text-[15px] font-normal leading-[1.2]">Years of expereince</p>
              </div>
            </div>
          </div>
        </section>`;
...
console.log('Successfully updated cards exactly based on Framer output.');
