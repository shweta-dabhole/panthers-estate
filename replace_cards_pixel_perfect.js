...
const newSection = `{/* 4. About Us Section (Who Are We) */}
        ...
        >
          ...
          {/* Centered Large Text */}
          <div className="max-w-[760px] text-center mb-20" ref={el => aboutTextRefs.current[1] = el}>
            <p className="text-[26px] md:text-[30px] font-normal text-[#111]" style={{ lineHeight: '1.5' }}>
          ...
          {/* Cards Section */}
          <div className="w-full max-w-[1240px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" ref={cardsSectionRef}>
            {/* Card 1 */}
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-10 pb-12 border-[1px] border-[#ebebeb] flex flex-col items-start justify-start">
              <div className="text-[#444] w-9 h-9 flex-none">
              ...
              <div className="mt-14 flex flex-col items-start w-full">
                <h4 className="text-[44px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-2">5000+</h4>
                <p className="text-[#333] text-[16px] font-normal leading-[1.2em]">Property deliverd</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-10 pb-12 border-[1px] border-[#ebebeb] flex flex-col items-start justify-start">
              ...
              <div className="mt-14 flex flex-col items-start w-full">
                <h4 className="text-[44px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-2">2000+</h4>
                <p className="text-[#333] text-[16px] font-normal leading-[1.2em]">Client served worldwide</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-10 pb-12 border-[1px] border-[#ebebeb] flex flex-col items-start justify-start">
              ...
              <div className="mt-14 flex flex-col items-start w-full">
                <h4 className="text-[44px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-2">100+</h4>
                <p className="text-[#333] text-[16px] font-normal leading-[1.2em]">Awards</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-10 pb-12 border-[1px] border-[#ebebeb] flex flex-col items-start justify-start">
              ...
              <div className="mt-14 flex flex-col items-start w-full">
                <h4 className="text-[44px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-2">12+</h4>
                <p className="text-[#333] text-[16px] font-normal leading-[1.2em]">Years of expereince</p>
              </div>
            </div>
          </div>
        </section>`;
...
console.log('Successfully updated padding, margins, and sizing to match cropped image exactly.');
