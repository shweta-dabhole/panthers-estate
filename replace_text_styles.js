...
const newSection = `{/* 4. About Us Section (Who Are We) */}
        ...
        >
          ...
          <div className="w-full max-w-[1200px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" ref={cardsSectionRef}>
            {/* Card 1 */}
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-8 pb-10 border-[1px] border-[#ebebeb] flex flex-col justify-between h-[280px]">
              <div className="text-[#333] w-[34px] h-[34px] flex-none">
              ...
              <div className="flex flex-col items-start w-full">
                <h4 className="text-[46px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-[6px]">5000+</h4>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-8 pb-10 border-[1px] border-[#ebebeb] flex flex-col justify-between h-[280px]">
              ...
              <div className="flex flex-col items-start w-full">
                <h4 className="text-[46px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-[6px]">2000+</h4>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-8 pb-10 border-[1px] border-[#ebebeb] flex flex-col justify-between h-[280px]">
              ...
              <div className="flex flex-col items-start w-full">
                <h4 className="text-[46px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-[6px]">100+</h4>
            ...
            <div className="stat-card bg-[#fcfcfc] rounded-[24px] px-8 pt-8 pb-10 border-[1px] border-[#ebebeb] flex flex-col justify-between h-[280px]">
              ...
              <div className="flex flex-col items-start w-full">
                <h4 className="text-[46px] font-[600] text-[#111] tracking-[-0.03em] leading-[1em] mb-[6px]">12+</h4>
...
console.log('Successfully reverted text styling to original presets.');
