...
const newSection = `{/* 4. About Us Section (Who Are We) */}
        ...
        >
          ...
          <div className="w-full max-w-[1200px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" ref={cardsSectionRef}>
            {/* Card 1 */}
            <div className="stat-card bg-[#f9f9f9] rounded-[15px] p-8 border-[1.3px] border-[#e6e6e6] flex flex-col items-start justify-start gap-5 h-[212px]">
              <div className="text-[#666666] w-8 h-8 flex-none">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18"></path><path d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16"></path><path d="M9 21v-4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4"></path></svg>
              </div>
...
console.log('Successfully applied strict Framer internal structure and dimensions.');
