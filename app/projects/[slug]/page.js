...
export default async function ProjectSlugPage({ params }) {
  ...
  const filePath = path.join(process.cwd(), 'public', 'mersi-scraped-site', 'www.mersi-architecture.com', 'projets', slug, 'index.html');
...
export function generateStaticParams() {
  const projetsDir = path.join(process.cwd(), 'public', 'mersi-scraped-site', 'www.mersi-architecture.com', 'projets');
  try {
