...
export default function ProcessPage() {
  ...
  useEffect(() => {
    ...
    document.documentElement.setAttribute('data-wf-page', '698217da6a7a7c705f60def8'); // Extracted from process/index.html
    ...
    const initScripts = async () => {
      try {
        ...
        console.log("All Webflow scripts loaded successfully for Process page!");
