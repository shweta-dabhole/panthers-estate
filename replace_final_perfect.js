...
const newSection = `{/* 4. About Us Section (Who Are We) */}
        ...
        >
          ...
          <div className="w-full max-w-[1200px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" ref={cardsSectionRef}>
            {/* Card 1 */}
            <div className="stat-card bg-[#fafafa] rounded-[15px] p-8 border-[1.3px] border-[#f0f0f0] flex flex-col items-start gap-5">
              <div className="text-[#333] w-[32px] h-[32px] flex-none">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <h4 className="text-[40px] font-[600] text-[#111] tracking-[-0.04em] leading-[1em]">5000+</h4>
                <p className="text-[#333] text-[15px] font-normal leading-[1.2em]">Property deliverd</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fafafa] rounded-[15px] p-8 border-[1.3px] border-[#f0f0f0] flex flex-col items-start gap-5">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <h4 className="text-[40px] font-[600] text-[#111] tracking-[-0.04em] leading-[1em]">2000+</h4>
                <p className="text-[#333] text-[15px] font-normal leading-[1.2em]">Client served worldwide</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fafafa] rounded-[15px] p-8 border-[1.3px] border-[#f0f0f0] flex flex-col items-start gap-5">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <h4 className="text-[40px] font-[600] text-[#111] tracking-[-0.04em] leading-[1em]">100+</h4>
                <p className="text-[#333] text-[15px] font-normal leading-[1.2em]">Awards</p>
              </div>
            </div>
            ...
            <div className="stat-card bg-[#fafafa] rounded-[15px] p-8 border-[1.3px] border-[#f0f0f0] flex flex-col items-start gap-5">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <h4 className="text-[40px] font-[600] text-[#111] tracking-[-0.04em] leading-[1em]">12+</h4>
                <p className="text-[#333] text-[15px] font-normal leading-[1.2em]">Years of expereince</p>
              </div>
            </div>
          </div>
        </section>`;
...
console.log('Successfully reverted cards to tight gap-5 structure while keeping massive text gap and exact text sizing.');
